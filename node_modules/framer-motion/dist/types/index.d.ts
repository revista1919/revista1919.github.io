            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {Object.entries(c.levels).map(([val, info]) => (
                ...
                >
                  ...
                  <p className="text-sm text-gray-800 leading-snug break-words">{info.label.split('=')[1]?.trim()}</p>
                  {scores[c.key] == val && (
    ...
    >
      ...
      <div className="mt-auto pt-4 border-t border-gray-50 space-y-2">
        <div className="flex justify-between text-xs text-gray-500 font-sans">
          <span>DEADLINE</span>
          <span className="font-bold break-words">{assignment.Plazo ? new Date(assignment.Plazo).toLocaleDateString() : 'NO DATE'}</span>
        </div>
        <div className="flex justify-between text-xs text-gray-500 font-sans">
          <span>STATUS</span>
            ...
            >
              ...
              {loading ? (
                ...
                >
                  ...
                  <h3 className="mt-4 font-serif text-xl font-bold text-gray-900 break-words">No assignments {activeTab === 'assignments' ? 'pending' : 'completed'} at this time.</h3>
