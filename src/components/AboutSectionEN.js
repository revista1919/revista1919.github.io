      ...
      <div className="max-w-6xl mx-auto px-6 md:px-12">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold tracking-tight mb-6 leading-[1.15]">
            ...
            of <span className="italic text-[#FF5722]">scientific rigor</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 xl:gap-20 mb-24 md:mb-32">
          ...
          >
            <p>
              The <strong className="text-[#002147] font-semibold">National Review of Sciences for Students</strong> is a high-standard academic publication. Our purpose is to democratize access to scientific publishing and demonstrate that research talent doesn't have to wait for graduate school.
            </p>
            ...
            <div>
              <h3 className="text-xl md:text-2xl font-serif font-bold text-[#002147] mb-4 flex items-center gap-3">
                ...
                Scientific Committee of Excellence
              </h3>
              <p>
                The rigor of our publications is backed by a <strong className="text-[#002147]">constantly growing Scientific Committee</strong>, comprised of distinguished academics and professors from the country's leading universities. They ensure that each article strictly meets international evaluation standards through <span className="font-semibold text-[#002147]">double-blind peer review</span>.
              </p>
            </div>
          </motion.div>

          {/* Side Column — PentaUC (redesigned) */}
          <motion.div 
            initial={{ opacity: 0, y: 24 }}
            whileInView={{ opacity: 1, y: 0 }}
            ...
            <div className="group relative bg-[#002147] text-white rounded-2xl overflow-hidden shadow-2xl shadow-[#002147]/25">
              ...
              <div className="p-7 md:p-8 relative">
                ...
                <h4 className="text-2xl md:text-[26px] font-serif font-bold mb-4 leading-tight">
                  Recognized by PentaUC
                </h4>
                
                <p className="text-white/75 text-[15px] font-light leading-relaxed mb-7">
                  The Talent Academy of the Pontifical Catholic University of Chile highlighted our initiative for showcasing high school and university research nationwide.
                </p>
