      ...
      <div className="flex items-start gap-2">
        ...
        <div>
          <p className="text-xs font-medium text-yellow-800">
            {isSpanish ? 'Documento de revisión no disponible. Por favor salga de esta plataforma de envío y vuelva a entrar. Puede entrar por la pestaña "Login"' : 'Review document not available. Please exit this platform and re-enter. You can log in throught the "Login" tab'}
          </p>
