  ...
  return (
    <div className={`max-w-7xl mx-auto px-4 py-12 bg-white text-gray-900 ${className || ""}`}>
      ...
      <div className="flex flex-col gap-12">
        {/* 1. FEATURED ARTICLE (Most Recent) */}
        {featured && (
          <motion.article
            ...
            <div className="lg:col-span-7 flex flex-col gap-8">
              ...
              {welcomeNote && welcomeNote.fechaIso !== featured.fechaIso && (
                <div className="group/welcome cursor-pointer" onClick={(e) => { e.stopPropagation(); openNews(welcomeNote); }}>
                  <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-blue-600 mb-4 block">Editorial Note</span>
        ...
        {/* 2. GRID OF REMAINING NEWS (Perfect Symmetry) */}
            ...
            {listNews.map((item, idx) => (
              ...
              >
                <div className="mb-3 h-32 bg-gray-100 rounded overflow-hidden">
                  <img
                    src={item.photo ? item.photo : "https://via.placeholder.com/400x225?text=News+Image"}
                    className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700"
                    alt={item.titulo}
                  />
                </div>
