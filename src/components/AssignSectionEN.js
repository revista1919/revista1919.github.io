      ...
      const htmlBody = `
        <div style="font-family: 'Georgia', serif; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f8f1e9; border: 2px solid #8b5a2b; border-radius: 10px; color: #3c2f2f;">
          ...
          <div style="padding: 20px;">
            <p>Estimado/a ${name},</p>
            <p>Le escribimos para recordarle amablemente que tiene pendiente la revisión del artículo <strong>${title}</strong> como <strong>${body.role}</strong> en la <strong>Revista Nacional de las Ciencias para Estudiantes</strong>.</p>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg p-6 max-w-md w-full max-h-[80vh] overflow-y-auto">
            ...
            <p className="text-sm font-medium mb-4">
              <strong>Intereses:</strong> {(selectedUser['Areas of interest'] || selectedUser['Áreas de interés'] || '').split(';').map(i => i.trim()).join(', ') || 'N/A'}
            </p>
