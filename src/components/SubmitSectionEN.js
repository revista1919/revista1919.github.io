...
function SubmitSection() {
  return React.createElement(
    ...
    React.createElement('p', { className: 'text-sm sm:text-base mb-3 sm:mb-4' }, React.createElement('strong', null, 'Important: do not include your name in any part of yout paper'), ' - only in the form below.'),
