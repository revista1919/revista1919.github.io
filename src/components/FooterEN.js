      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16 items-center">
          <div className="text-left">
            <h3 className="text-xl font-serif mb-2 italic">Newsletter</h3>
            <p className="text-gray-500 text-sm font-light">
              Receive the latest publications and scientific news directly in your inbox.
            </p>
          </div>
          <div>
            {!submitted ? (
        ...
        <div className="pt-8 border-t border-gray-900 flex flex-col items-center gap-4">
          ...
          <div className="flex gap-4 text-[9px] text-gray-700 uppercase tracking-widest">
            <a href="/privacyEN.html" className="hover:text-white transition-colors">Privacy</a>
            <span>|</span>
            <a href="/termsEN.html" className="hover:text-white transition-colors">Terms</a>
            <span>|</span>
            <a href="/creditsEN.html" className="hover:text-white transition-colors">Credits</a>
          </div>
        </div>
      </div>
    </motion.footer>
