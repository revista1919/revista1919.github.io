                    ...
                    if (currentAssignments.length === 0) {
                      return (
                        ...
                        >
                          ...
                          <h3 className="mt-4 text-xl font-semibold text-gray-800">No {activeTab === 'assignments' ? 'pending' : 'completed'} assignments at the moment.</h3>
