    ...
    <div className="relative overflow-hidden bg-white">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 pt-4 pb-20 sm:pt-6 sm:pb-32">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center mb-16 sm:mb-32">
          ...
          >
            {/* HOOK VISUAL PARA MÓVIL: Una línea decorativa vertical */}
            <div className="w-1 h-12 bg-blue-600 mb-6 mx-auto lg:mx-0 lg:hidden" />
            ...
            {/* IMAGEN PARA MÓVIL (Solo visible en pantallas pequeñas) */}
            <motion.div
            ...
            <p className="text-base sm:text-lg text-gray-600 mb-8 sm:mb-10 font-light leading-relaxed max-w-lg mx-auto lg:mx-0 text-center lg:text-left">
              La plataforma dedicada a la difusión de trabajos científicos desarrollados por estudiantes, promoviendo el aprendizaje y la discusión académica.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <button
                onClick={() => navigate('/article')}
                className="px-8 sm:px-10 py-4 bg-gray-900 text-white font-bold text-xs uppercase tracking-widest hover:bg-blue-600 transition-all shadow-2xl hover:-translate-y-1 active:scale-95"
              >
                Ver artículos
              </button>
              <button
