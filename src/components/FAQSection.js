...
function FAQSection() {
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement('li', null, React.createElement('strong', null, '¿Quién puede publicar?'), ' Cualquier estudiante escolar de Chile.'),
      ...
      React.createElement('li', null, React.createElement('strong', null, '¿Cuánto se demoran en responder?'), ' Entre 1 y 3 semanas.'),
      React.createElement('li', null, React.createElement('strong', null, '¿Cómo se revisa un artículo?'), ' Revisión ciega, sin nombre del autor.'),
