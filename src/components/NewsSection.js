  ...
  return (
    <div className={`w-full bg-[#FCFCFB] text-[#111] min-h-screen pb-24 ${className || ""}`}>
      ...
      <style dangerouslySetInnerHTML={{
        ...
        /* Limpieza de HTML proveniente de CMS */
        ...
        /* Simulación de columnas de periódico para institucional */
        .newspaper-columns {
          column-count: 1;
          column-gap: 2rem;
        }
      ...
      <div className="max-w-[1600px] mx-auto px-4 md:px-8 pt-12">
          ...
          <div className="flex flex-col md:flex-row justify-between items-end border-b-[4px] border-[#0F172A] pb-6 mb-4 gap-6">
            <div>
              ...
              <p className="font-system font-bold uppercase tracking-[0.25em] text-xs text-slate-500 mt-4 ml-1">
                Revista Estudiantil de Investigación y Avances
              </p>
            </div>
        ...
        {(activeTab === 'all' || activeTab === 'science') && scienceNews.length > 0 && (
          <section className="mb-20">
                  ...
                  {sidebarScienceNews.map((item, idx) => (
                    ...
                    >
                      ...
                      <div className="editorial-abstract text-small truncate-2 mb-3">
                        {decodeBody(item.content_es, true, 120)}
                      </div>
            ...
            {/* BLOQUE MEDIO: Fila Visual (4 columnas iguales) para dar peso a las imágenes */}
            ...
            {/* BLOQUE INFERIOR: Más noticias estilo lista si existen */}
        ...
        {/* --- SECCIÓN: INSTITUCIONAL Y NEWSLETTER (BOLETÍN DENSO) --- */}
        {(activeTab === 'all' || activeTab === 'internal') && news.length > 0 && (
          <section className="bg-slate-100/50 border-t-4 border-[#0F172A] py-12 px-6 md:px-12 -mx-4 md:-mx-8 rounded-sm">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
              ...
              {/* Lista Densa de Noticias Internas (8 columnas) usando Masonry/Columns CSS */}
              <div className="lg:col-span-8">
                <div className="newspaper-columns">
                  {filteredInternalNews.map((item, idx) => (
                    ...
                    >
                      {/* Cita decorativa tipo telegrama */}
              ...
              {/* Sidebar Derecha: Newsletter (4 columnas) */}
              <div className="lg:col-span-4 flex flex-col gap-8">
                <div className="sticky top-8">
                  <NewsletterSubscription variant="compact" showTitle={false} />
                  
                  {/* Espacio para enlaces rápidos o info extra si es necesario */}
                  <div className="mt-8 border-t border-slate-300 pt-6">
                    ...
                    <ul className="flex flex-col gap-3 font-journal text-sm text-[#0F172A]">
                      <li><a href="#" className="hover:text-[#EA580C] underline decoration-slate-300 underline-offset-4">Normativa de Publicaciones</a></li>
                      <li><a href="#" className="hover:text-[#EA580C] underline decoration-slate-300 underline-offset-4">Directorio de Autores</a></li>
                      <li><a href="#" className="hover:text-[#EA580C] underline decoration-slate-300 underline-offset-4">Archivos Históricos</a></li>
                    </ul>
                  </div>
                </div>
              </div>
